...
# Title: AAUSAT4 receiver
# Generated: Tue Apr  9 02:03:48 2019
##################################################
...
class satnogs_aausat4_gmsk_decoder(grc_wxgui.top_block_gui):

    def __init__(self, antenna=satnogs.not_set_antenna, bb_gain=satnogs.not_set_rx_bb_gain, decoded_data_file_path='/tmp/.satnogs/data/data', dev_args=satnogs.not_set_dev_args, doppler_correction_per_sec=5, enable_iq_dump=1, file_path='test.ogg', if_gain=satnogs.not_set_rx_if_gain, iq_file_path='/tmp/iq.dat', lo_offset=100e3, ppm=0, rf_gain=satnogs.not_set_rx_rf_gain, rigctl_port=4532, rx_freq=437.425e6, rx_sdr_device='airspy', waterfall_file_path='/tmp/waterfall.dat'):
        grc_wxgui.top_block_gui.__init__(self, title="AAUSAT4 receiver")
        ...
        self.samp_per_sym = samp_per_sym = audio_samp_rate/2400
        ...
        self.satnogs_frame_file_sink_0 = satnogs.frame_file_sink(decoded_data_file_path, 0)
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_gr_complex*1, '/home/nickoe/satnogs_station/IQ/48000sps_aausat4_pass.dat', False)
        ...
        self.msg_connect((self.aausat_aausat4_fec_0, 'out'), (self.satnogs_frame_file_sink_0, 'frame'))
    ...
    def set_audio_samp_rate(self, audio_samp_rate):
        ...
        self.set_samp_per_sym(self.audio_samp_rate/2400)
...
def main(top_block_cls=satnogs_aausat4_gmsk_decoder, options=None):
    if options is None:
